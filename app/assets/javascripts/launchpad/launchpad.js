$(document).ready(function () {
    ...
    var getSuccess = function(response) {
        if (response.status === 'running') {
            ...
            $('#waiting .page-container').append('<p>&nbsp;</p>');
            $('#waiting .page-container').append('<p>We are preparing your project URL, we just need a few minutes for DNS to propagate. <br/>This URL will be available soon.</p>');
